...
public class ActivityMusic extends AppCompatActivity implements View.OnClickListener
{
    ...
    private void FillList() throws IllegalAccessException {
        ...
        for (int i=0; i<fields.length; i++)
        {
            ...
            System.out.println(R.raw.america_sandman);
        ...
        adapter = new AdapterSong(this, listItems);
    ...
    private void setUpUI()
    {
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.love_the_one);
